...
imap <C-K> <F7>
imap <C-P><C-P> :w:!pdflatex %
imap <C-P><C-U> :let b:Imap_FreezeImap = 0
imap <C-P><C-F> :let b:Imap_FreezeImap = 1
nmap  :call VimuxOpenRunner()
nmap 	 :lprev 
...
xnoremap <silent> <C-N> :call multiple_cursors#new("v")
nnoremap <silent> <C-N> :call multiple_cursors#new("n")
...
nmap <C-P><C-P> :w:!pdflatex %
nmap <C-C><C-O> :call VimuxOpenRunner()
nmap <C-K> :lnext
nmap <C-I> :lprev 
...
imap  mjax<F7>
imap  :w:!pdflatex %
imap  :let b:Imap_FreezeImap = 0
imap  :let b:Imap_FreezeImap = 1
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set background=dark
...
set mouse=n
set ruler
set runtimepath=~/.vim,~/.vim/bundle/benmills-vimux-37f4119,~/.vim/bundle/vim-bufkill,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/after
set shiftwidth=2
set showcmd
set softtabstop=2
...
wincmd w
argglobal
if bufexists("tokens.h") | buffer tokens.h | else | edit tokens.h | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
